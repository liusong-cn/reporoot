package algorithm.linkk;

/**
 * @author: ls
 * @date: 2020/6/22 0022 15:46
 */
public class Bin<T extends  Comparable<T>> {
    ...
    public static void main(String[] args) {
        ...
        b.put(8);
        b.put(3);
       // System.out.println(b.getEntry(10).item);
        b.remove(20);
        b.prevIterator(b.root);
