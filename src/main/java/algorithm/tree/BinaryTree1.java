...
public class BinaryTree1<Key extends Comparable<Key>, Value> {
    ...
    private void preErgodic(Node x,Queue1<Key> keys){
        if (x==null){
            return;
        }
    ...
    private void midErgodic(Node x,Queue1<Key> keys){
        if (x==null){
            return;
        }
        //先递归，把左子树中的键放到keys中
    ...
    //使用后序遍历，把整个树中所有的键返回
    public Queue1<Key> afterErgodic(){
        Queue1<Key> keys = new Queue1<>();
    ...
    private void afterErgodic(Node x,Queue1<Key> keys){
        if (x==null){
            return ;
        }
    ...
    //使用层序遍历，获取整个树中所有的键
    public Queue1<Key> layerErgodic(){
        //定义两个队列，分别存储树中的键和树中的结点
        Queue1<Key> keys = new Queue1<>();
        Queue1<Node> nodes = new Queue1<>();
...
//        BinaryTree1<Integer,String> b = new BinaryTree1();
//        b.put(10,"a");
//        b.put(2,"b");
//        b.put(3,"c");
//        b.put(1,"f");
...
//        b.put(11,"g");
//        b.delete(2);
//        Queue1<Integer> keys = b.preErgodic();
//        for (int i = 0; i < 6; i++) {
//            System.out.println(b.get(keys.dequeue()));
//        }
        BinaryTree1<String, String> tree = new BinaryTree1<>();
        //往树中添加数据
        tree.put("E", "5");
        tree.put("B", "2");
        tree.put("G", "7");
        ...
        //遍历
        Queue1<String> keys = tree.preErgodic();
        for (String key : keys) {
